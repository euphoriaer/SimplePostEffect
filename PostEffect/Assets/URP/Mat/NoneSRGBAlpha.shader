	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 gammaToLinear6 = FastSRGBToLinear( tex2DNode5.rgb );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = gammaToLinear6;
