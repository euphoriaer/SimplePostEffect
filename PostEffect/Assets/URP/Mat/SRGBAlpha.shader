	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 temp_cast_1 = (tex2DNode6.a).xxx;
				float3 temp_cast_2 = (tex2DNode6.a).xxx;
				float3 gammaToLinear8 = Gamma22ToLinear( temp_cast_2 );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = tex2DNode6.rgb;
				float Alpha = gammaToLinear8.x;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 tex2DNode6 = tex2D( _MainTex, uv_MainTex );
				float3 temp_cast_0 = (tex2DNode6.a).xxx;
				float3 temp_cast_1 = (tex2DNode6.a).xxx;
				float3 gammaToLinear8 = Gamma22ToLinear( temp_cast_1 );
...
/*ASEBEGIN
Version=18912
7;24;1920;995;1157;413.5;1;True;True
Node;AmplifyShaderEditor.SamplerNode;6;-562,-130.5;Inherit;True;Property;_MainTex;_MainTex;0;0;Create;True;0;0;0;False;0;False;-1;None;7aafbaa00f416214f86dc5978b480369;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GammaToLinearNode;8;-120,38.5;Inherit;False;3;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
