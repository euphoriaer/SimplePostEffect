            ...
            Pass
            {
                ...
                half4 frag(Varyings input) : SV_Target
                {
                    ...
                    c.rgb = SRGBToLinear(c.rgb);
                        ...
                        float cloudA = (1 - max(0, mask.r));
                        cloudA = max(_UseNewMASK, min(1, cloudA + mask.r * cloudA));
                        c.rgb = lerp(c.rgb, c.rgb * _MaskEndColor * _MaskEndBrightness, cloudMask.a * cloudA);
